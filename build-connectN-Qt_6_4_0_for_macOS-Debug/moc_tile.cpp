...
Q_CONSTINIT static const qt_meta_stringdata_Tile_t qt_meta_stringdata_Tile = {
    {
        ...
        QT_MOC_LITERAL(5, 12),  // "TileSelected"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 5),  // "Tile*"
        QT_MOC_LITERAL(25, 1)   // "t"
    },
    "Tile",
    "TileSelected",
    "",
...
void Tile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->TileSelected((*reinterpret_cast< std::add_pointer_t<Tile*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Tile::TileSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Tile::TileSelected(Tile * _t1)
{
